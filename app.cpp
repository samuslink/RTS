...
HRESULT APPLICATION::Init(HINSTANCE hInstance, int width, int height, bool windowed)
{
	...
	RegisterClass(&wc);
	m_mainWindow = CreateWindow("D3DWND", "The Game!", WS_EX_TOPMOST, 0, 0, width, height, 0, 0, hInstance, 0); 
	SetCursor(NULL);
	...
	//Menu
	D3DXCreateTextureFromFile(m_pDevice, "textures/MenuBD.bmp", &m_pMenuTexture);
